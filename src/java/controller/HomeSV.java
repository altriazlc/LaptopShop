 ...
 * @author nhhag
 */
@WebServlet(name = "HomeSV", urlPatterns = {"/home"})
public class HomeSV extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        List<laptop> list = d.get5LastestLaptop();
        List<laptop> list2 = d.get5BestSellerLaptop();
        laptop p = d.getFeatureLaptop();
        if(a!= null){
